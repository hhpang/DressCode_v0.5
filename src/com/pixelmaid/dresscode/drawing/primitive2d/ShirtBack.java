...
public class ShirtBack extends LShape {
	
	private String shapePath = "/Users/Pang/Desktop/patterns/shirtback.svg"; //path to svg to be loaded
	...
	private double height = 0;
	    ...
	    @Override
	    public ShirtBack copy(){
	    	ShirtBack s = new ShirtBack();
