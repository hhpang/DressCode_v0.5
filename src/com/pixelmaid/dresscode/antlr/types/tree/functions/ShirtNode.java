...
import com.pixelmaid.dresscode.drawing.primitive2d.Shirt;
import com.pixelmaid.dresscode.events.CustomEvent;

public class ShirtNode extends DrawableNode implements DCNode {

	public ShirtNode(List<DCNode> ps, int l) {
		super(ps,l);
	...
	public VarType evaluate() {
		...
		try{
			...
			if(params.get(0).evaluate().isString()){
				...
				//Window.output.setText("incorrect parameters for Shirt call at line:"+line);

				System.err.println("inccorect arguments for Shirt at line:"+line);
			}
